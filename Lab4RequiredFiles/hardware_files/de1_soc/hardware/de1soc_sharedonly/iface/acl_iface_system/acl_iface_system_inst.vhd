	component acl_iface_system is
		port (
			...
			seven_segment_pio_export            : out   std_logic_vector(15 downto 0)                      -- export
		);
	...
	u0 : component acl_iface_system
		port map (
			...
			seven_segment_pio_export            => CONNECTED_TO_seven_segment_pio_export             -- seven_segment_pio.export
		);
