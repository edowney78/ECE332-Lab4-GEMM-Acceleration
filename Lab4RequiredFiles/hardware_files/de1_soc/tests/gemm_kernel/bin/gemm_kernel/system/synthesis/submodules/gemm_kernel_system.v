...
(
   ...
   logic [287:0] gemm_kernel_kernel_arguments;
...
(
   ...
   begin:gmem0_
      ...
      // INST global_ic_preroutegmem0_router_0 of gemm_kernel_system_interconnect_0
      gemm_kernel_system_interconnect_0 global_ic_preroutegmem0_router_0
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_ic_preroutegmem0_router_1 of gemm_kernel_system_interconnect_0
      gemm_kernel_system_interconnect_0 global_ic_preroutegmem0_router_1
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      assign icm_groupgmem0_router_2_arb_enable[0] = gmem0_icm_in_arb_enable[2];
      ...
      // INST global_ic_preroutegmem0_router_2 of gemm_kernel_system_interconnect_1
      gemm_kernel_system_interconnect_1 global_ic_preroutegmem0_router_2
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      // INST global_icgmem0_port_0_0_rw of gemm_kernel_system_interconnect_2
      gemm_kernel_system_interconnect_2 global_icgmem0_port_0_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
...
/////////////////////////////////////////////////////////////////
// MODULE gemm_kernel_system_interconnect_0
/////////////////////////////////////////////////////////////////
module gemm_kernel_system_interconnect_0
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE gemm_kernel_system_interconnect_1
/////////////////////////////////////////////////////////////////
module gemm_kernel_system_interconnect_1
(
   input logic clock,
...
/////////////////////////////////////////////////////////////////
// MODULE gemm_kernel_system_interconnect_2
/////////////////////////////////////////////////////////////////
module gemm_kernel_system_interconnect_2
(
   input logic clock,
