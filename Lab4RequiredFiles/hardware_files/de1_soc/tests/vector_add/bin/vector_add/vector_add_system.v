...
(
   ...
   // INST vector_add_std_ic_inst of vector_add_std_ic_partition_wrapper
   vector_add_std_ic_partition_wrapper vector_add_std_ic_inst
   (
      .clock(clock),
      .clock2x(clock2x),
      .resetn(resetn),
      .cra_irq_vector_add(kernel_irqs),
      // AVS avs_vector_add_cra
      .avs_vector_add_cra_enable(avs_vector_add_cra_enable),
      .avs_vector_add_cra_read(avs_vector_add_cra_read),
      .avs_vector_add_cra_write(avs_vector_add_cra_write),
      .avs_vector_add_cra_address(avs_vector_add_cra_address),
      .avs_vector_add_cra_writedata(avs_vector_add_cra_writedata),
      .avs_vector_add_cra_byteenable(avs_vector_add_cra_byteenable),
      .avs_vector_add_cra_readdata(avs_vector_add_cra_readdata),
      .avs_vector_add_cra_readdatavalid(avs_vector_add_cra_readdatavalid),
      // AVM vector_add_0_avm_unnamed_vector_add0
      .vector_add_0_avm_unnamed_vector_add0_enable(gmem0_global_avm_enable[0]),
      .vector_add_0_avm_unnamed_vector_add0_read(gmem0_global_avm_read[0]),
      .vector_add_0_avm_unnamed_vector_add0_write(gmem0_global_avm_write[0]),
      .vector_add_0_avm_unnamed_vector_add0_burstcount(gmem0_global_avm_burstcount[0]),
      .vector_add_0_avm_unnamed_vector_add0_address(gmem0_global_avm_address[0]),
      .vector_add_0_avm_unnamed_vector_add0_writedata(gmem0_global_avm_writedata[0]),
      .vector_add_0_avm_unnamed_vector_add0_byteenable(gmem0_global_avm_byteenable[0]),
      .vector_add_0_avm_unnamed_vector_add0_waitrequest(gmem0_global_avm_waitrequest[0]),
      .vector_add_0_avm_unnamed_vector_add0_readdata(gmem0_global_avm_readdata[0]),
      .vector_add_0_avm_unnamed_vector_add0_readdatavalid(gmem0_global_avm_readdatavalid[0]),
      .vector_add_0_avm_unnamed_vector_add0_writeack(gmem0_global_avm_writeack[0]),
      // AVM vector_add_0_avm_unnamed_vector_add1
      .vector_add_0_avm_unnamed_vector_add1_enable(gmem0_global_avm_enable[1]),
      .vector_add_0_avm_unnamed_vector_add1_read(gmem0_global_avm_read[1]),
      .vector_add_0_avm_unnamed_vector_add1_write(gmem0_global_avm_write[1]),
      .vector_add_0_avm_unnamed_vector_add1_burstcount(gmem0_global_avm_burstcount[1]),
      .vector_add_0_avm_unnamed_vector_add1_address(gmem0_global_avm_address[1]),
      .vector_add_0_avm_unnamed_vector_add1_writedata(gmem0_global_avm_writedata[1]),
      .vector_add_0_avm_unnamed_vector_add1_byteenable(gmem0_global_avm_byteenable[1]),
      .vector_add_0_avm_unnamed_vector_add1_waitrequest(gmem0_global_avm_waitrequest[1]),
      .vector_add_0_avm_unnamed_vector_add1_readdata(gmem0_global_avm_readdata[1]),
      .vector_add_0_avm_unnamed_vector_add1_readdatavalid(gmem0_global_avm_readdatavalid[1]),
      .vector_add_0_avm_unnamed_vector_add1_writeack(gmem0_global_avm_writeack[1]),
      // AVM vector_add_0_avm_unnamed_vector_add2
      .vector_add_0_avm_unnamed_vector_add2_enable(gmem0_global_avm_enable[2]),
      .vector_add_0_avm_unnamed_vector_add2_read(gmem0_global_avm_read[2]),
      .vector_add_0_avm_unnamed_vector_add2_write(gmem0_global_avm_write[2]),
      .vector_add_0_avm_unnamed_vector_add2_burstcount(gmem0_global_avm_burstcount[2]),
      .vector_add_0_avm_unnamed_vector_add2_address(gmem0_global_avm_address[2]),
      .vector_add_0_avm_unnamed_vector_add2_writedata(gmem0_global_avm_writedata[2]),
      .vector_add_0_avm_unnamed_vector_add2_byteenable(gmem0_global_avm_byteenable[2]),
      .vector_add_0_avm_unnamed_vector_add2_waitrequest(gmem0_global_avm_waitrequest[2]),
      .vector_add_0_avm_unnamed_vector_add2_readdata(gmem0_global_avm_readdata[2]),
      .vector_add_0_avm_unnamed_vector_add2_readdatavalid(gmem0_global_avm_readdatavalid[2]),
      .vector_add_0_avm_unnamed_vector_add2_writeack(gmem0_global_avm_writeack[2])
   );
...
/////////////////////////////////////////////////////////////////
// MODULE vector_add_std_ic_partition_wrapper
/////////////////////////////////////////////////////////////////
module vector_add_std_ic_partition_wrapper
(
   input logic clock,
   input logic clock2x,
   input logic resetn,
   output logic cra_irq_vector_add,
   // AVS avs_vector_add_cra
   input logic avs_vector_add_cra_enable,
   input logic avs_vector_add_cra_read,
   input logic avs_vector_add_cra_write,
   ...
   output logic avs_vector_add_cra_readdatavalid,
   // AVM vector_add_0_avm_unnamed_vector_add0
   output logic vector_add_0_avm_unnamed_vector_add0_enable,
   output logic vector_add_0_avm_unnamed_vector_add0_read,
   output logic vector_add_0_avm_unnamed_vector_add0_write,
   output logic [4:0] vector_add_0_avm_unnamed_vector_add0_burstcount,
   output logic [29:0] vector_add_0_avm_unnamed_vector_add0_address,
   output logic [255:0] vector_add_0_avm_unnamed_vector_add0_writedata,
   output logic [31:0] vector_add_0_avm_unnamed_vector_add0_byteenable,
   input logic vector_add_0_avm_unnamed_vector_add0_waitrequest,
   input logic [255:0] vector_add_0_avm_unnamed_vector_add0_readdata,
   input logic vector_add_0_avm_unnamed_vector_add0_readdatavalid,
   input logic vector_add_0_avm_unnamed_vector_add0_writeack,
   // AVM vector_add_0_avm_unnamed_vector_add1
   output logic vector_add_0_avm_unnamed_vector_add1_enable,
   output logic vector_add_0_avm_unnamed_vector_add1_read,
   output logic vector_add_0_avm_unnamed_vector_add1_write,
   output logic [4:0] vector_add_0_avm_unnamed_vector_add1_burstcount,
   output logic [29:0] vector_add_0_avm_unnamed_vector_add1_address,
   output logic [255:0] vector_add_0_avm_unnamed_vector_add1_writedata,
   output logic [31:0] vector_add_0_avm_unnamed_vector_add1_byteenable,
   input logic vector_add_0_avm_unnamed_vector_add1_waitrequest,
   input logic [255:0] vector_add_0_avm_unnamed_vector_add1_readdata,
   input logic vector_add_0_avm_unnamed_vector_add1_readdatavalid,
   input logic vector_add_0_avm_unnamed_vector_add1_writeack,
   // AVM vector_add_0_avm_unnamed_vector_add2
   output logic vector_add_0_avm_unnamed_vector_add2_enable,
   output logic vector_add_0_avm_unnamed_vector_add2_read,
   output logic vector_add_0_avm_unnamed_vector_add2_write,
   output logic [4:0] vector_add_0_avm_unnamed_vector_add2_burstcount,
   output logic [29:0] vector_add_0_avm_unnamed_vector_add2_address,
   output logic [255:0] vector_add_0_avm_unnamed_vector_add2_writedata,
   output logic [31:0] vector_add_0_avm_unnamed_vector_add2_byteenable,
   input logic vector_add_0_avm_unnamed_vector_add2_waitrequest,
   input logic [255:0] vector_add_0_avm_unnamed_vector_add2_readdata,
   input logic vector_add_0_avm_unnamed_vector_add2_readdatavalid,
   input logic vector_add_0_avm_unnamed_vector_add2_writeack
);
   logic vector_add_start;
   logic [0:0] vector_add_start_chain;
   logic [0:0] vector_add_start_kernel_copy;
   logic [0:0] vector_add_start_task_fd;
   logic [0:0] vector_add_start_finish_element;
   logic vector_add_finish;
   logic [0:0] vector_add_finish_kernel_copy;
   logic [0:0] vector_add_finish_chain;
   logic [31:0] vector_add_global_size [2:0];
   logic [31:0] vector_add_num_groups [2:0];
   logic [31:0] vector_add_local_size [2:0];
   logic [31:0] vector_add_global_offset [2:0];
   logic [31:0] vector_add_work_dim;
   logic [31:0] vector_add_wg_size;
   logic [0:0] vector_add_wg_disp_stall_in;
   logic [0:0] vector_add_wg_disp_stall_in_lookahead;
   logic [0:0] vector_add_wg_disp_valid_out;
   logic vector_add_wg_disp_start_out;
   logic [31:0] vector_add_wg_disp_group_id_out [2:0];
   logic [31:0] vector_add_wg_disp_global_id_base_out [2:0];
   logic vector_add_wg_disp_dispatched_all_groups;
   logic [31:0] vector_add_global_id [1][2:0];
   logic [31:0] vector_add_local_id [1][2:0];
   logic [31:0] vector_add_group_id [1][2:0];
   logic [0:0] vector_add_pending_write;
   logic [0:0] vector_add_lsu_active;
   logic [0:0] vector_add_valid_in;
   logic [0:0] vector_add_valid_out;
   logic [0:0] vector_add_stall_in;
   logic [0:0] vector_add_stall_out;
   logic vector_add_cra_pending_write;
   logic vector_add_cra_lsu_active;
   logic vector_add_cra_valid_in;
   logic [191:0] vector_add_kernel_arguments;

   assign vector_add_start_chain[0] = vector_add_start;
   assign vector_add_finish_chain[0] = 1'b1;
   assign vector_add_cra_pending_write = |vector_add_pending_write;
   assign vector_add_cra_lsu_active = |vector_add_lsu_active;
   assign vector_add_cra_valid_in = |vector_add_valid_in;
   assign vector_add_stall_in = 0;
   // INST vector_add_workgroup_dispatcher of acl_work_group_dispatcher
   ...
   vector_add_workgroup_dispatcher
   (
      .clock(clock),
      .resetn(resetn),
      .start(vector_add_start),
      .num_groups(vector_add_num_groups),
      .local_size(vector_add_local_size),
      .stall_in(vector_add_wg_disp_stall_in),
      .stall_in_lookahead(vector_add_wg_disp_stall_in_lookahead),
      .valid_out(vector_add_wg_disp_valid_out),
      .group_id_out(vector_add_wg_disp_group_id_out),
      .global_id_base_out(vector_add_wg_disp_global_id_base_out),
      .start_out(vector_add_wg_disp_start_out),
      .dispatched_all_groups(vector_add_wg_disp_dispatched_all_groups)
   );

   // INST vector_add_finish_detector of acl_kernel_finish_detector
   ...
   (
      ...
      .resetn(resetn),
      .start(vector_add_start),
      .wg_size(vector_add_wg_size),
      .wg_dispatch_valid_out(vector_add_wg_disp_valid_out),
      .wg_dispatch_stall_in(vector_add_wg_disp_stall_in),
      .dispatched_all_groups(vector_add_wg_disp_dispatched_all_groups),
      .kernel_copy_valid_out(vector_add_valid_out),
      .kernel_copy_stall_in(vector_add_stall_in),
      .pending_writes(vector_add_cra_pending_write),
      .finish(vector_add_finish)
   );

   // INST vector_add_cra_slave_inst of vector_add_function_cra_slave
   vector_add_function_cra_slave vector_add_cra_slave_inst
   (
      .clock(clock),
      .resetn(resetn),
      .start(vector_add_start),
      .finish(vector_add_finish),
      .global_offset_0(vector_add_global_offset[0]),
      .global_offset_1(vector_add_global_offset[1]),
      .global_offset_2(vector_add_global_offset[2]),
      .work_dim(vector_add_work_dim),
      .has_a_lsu_active(vector_add_cra_lsu_active),
      .has_a_write_pending(vector_add_cra_pending_write),
      .valid_in(vector_add_cra_valid_in),
      .global_size_0(vector_add_global_size[0]),
      .global_size_1(vector_add_global_size[1]),
      .global_size_2(vector_add_global_size[2]),
      .num_groups_0(vector_add_num_groups[0]),
      .num_groups_1(vector_add_num_groups[1]),
      .num_groups_2(vector_add_num_groups[2]),
      .local_size_0(vector_add_local_size[0]),
      .local_size_1(vector_add_local_size[1]),
      .local_size_2(vector_add_local_size[2]),
      .workgroup_size(vector_add_wg_size),
      .kernel_arguments(vector_add_kernel_arguments),
      .cra_irq(cra_irq_vector_add),
      // AVS avs_cra
   ...
   // INST vector_add_id_iter_inst_0 of acl_id_iterator
   acl_id_iterator
   #(
      .WIDTH(32),
      .LOCAL_WIDTH_X(32),
   ...
   vector_add_id_iter_inst_0
   (
      .clock(clock),
      .resetn(resetn),
      .start(vector_add_wg_disp_start_out),
      .valid_in(vector_add_wg_disp_valid_out[0]),
      .stall_out(vector_add_wg_disp_stall_in[0]),
      .stall_out_lookahead(vector_add_wg_disp_stall_in_lookahead[0]),
      .stall_in(vector_add_stall_out[0]),
      .valid_out(vector_add_valid_in[0]),
      .group_id_in(vector_add_wg_disp_group_id_out),
      .global_id_base_in(vector_add_wg_disp_global_id_base_out),
      .local_size(vector_add_local_size),
      .global_size(vector_add_global_size),
      .local_id(vector_add_local_id[0]),
      .global_id(vector_add_global_id[0]),
      .group_id(vector_add_group_id[0])
   );

   // INST vector_add_inst_0 of vector_add_top_wrapper_0
   vector_add_top_wrapper_0 vector_add_inst_0
   (
      .start(vector_add_start_kernel_copy[0]),
      .kernel_arguments(vector_add_kernel_arguments),
      .work_dim(vector_add_work_dim),
      .global_offset(vector_add_global_offset),
      .kernel_valid_out(vector_add_valid_out[0]),
      .has_a_write_pending(vector_add_pending_write[0]),
      .has_a_lsu_active(vector_add_lsu_active[0]),
      .global_id(vector_add_global_id[0]),
      .local_id(vector_add_local_id[0]),
      .group_id(vector_add_group_id[0]),
      .global_size(vector_add_global_size),
      ...
      .num_groups(vector_add_num_groups),
      .workgroup_size(vector_add_wg_size),
      .kernel_stall_out(vector_add_stall_out[0]),
      .kernel_valid_in(vector_add_valid_in[0]),
      .clock(clock),
      .resetn(resetn),
      .clock2x(clock2x),
      // AVM avm_unnamed_vector_add0
      .avm_unnamed_vector_add0_enable(vector_add_0_avm_unnamed_vector_add0_enable),
      .avm_unnamed_vector_add0_read(vector_add_0_avm_unnamed_vector_add0_read),
      .avm_unnamed_vector_add0_write(vector_add_0_avm_unnamed_vector_add0_write),
      .avm_unnamed_vector_add0_burstcount(vector_add_0_avm_unnamed_vector_add0_burstcount),
      .avm_unnamed_vector_add0_address(vector_add_0_avm_unnamed_vector_add0_address),
      .avm_unnamed_vector_add0_writedata(vector_add_0_avm_unnamed_vector_add0_writedata),
      .avm_unnamed_vector_add0_byteenable(vector_add_0_avm_unnamed_vector_add0_byteenable),
      .avm_unnamed_vector_add0_waitrequest(vector_add_0_avm_unnamed_vector_add0_waitrequest),
      .avm_unnamed_vector_add0_readdata(vector_add_0_avm_unnamed_vector_add0_readdata),
      .avm_unnamed_vector_add0_readdatavalid(vector_add_0_avm_unnamed_vector_add0_readdatavalid),
      .avm_unnamed_vector_add0_writeack(vector_add_0_avm_unnamed_vector_add0_writeack),
      // AVM avm_unnamed_vector_add1
      .avm_unnamed_vector_add1_enable(vector_add_0_avm_unnamed_vector_add1_enable),
      .avm_unnamed_vector_add1_read(vector_add_0_avm_unnamed_vector_add1_read),
      .avm_unnamed_vector_add1_write(vector_add_0_avm_unnamed_vector_add1_write),
      .avm_unnamed_vector_add1_burstcount(vector_add_0_avm_unnamed_vector_add1_burstcount),
      .avm_unnamed_vector_add1_address(vector_add_0_avm_unnamed_vector_add1_address),
      .avm_unnamed_vector_add1_writedata(vector_add_0_avm_unnamed_vector_add1_writedata),
      .avm_unnamed_vector_add1_byteenable(vector_add_0_avm_unnamed_vector_add1_byteenable),
      .avm_unnamed_vector_add1_waitrequest(vector_add_0_avm_unnamed_vector_add1_waitrequest),
      .avm_unnamed_vector_add1_readdata(vector_add_0_avm_unnamed_vector_add1_readdata),
      .avm_unnamed_vector_add1_readdatavalid(vector_add_0_avm_unnamed_vector_add1_readdatavalid),
      .avm_unnamed_vector_add1_writeack(vector_add_0_avm_unnamed_vector_add1_writeack),
      // AVM avm_unnamed_vector_add2
      .avm_unnamed_vector_add2_enable(vector_add_0_avm_unnamed_vector_add2_enable),
      .avm_unnamed_vector_add2_read(vector_add_0_avm_unnamed_vector_add2_read),
      .avm_unnamed_vector_add2_write(vector_add_0_avm_unnamed_vector_add2_write),
      .avm_unnamed_vector_add2_burstcount(vector_add_0_avm_unnamed_vector_add2_burstcount),
      .avm_unnamed_vector_add2_address(vector_add_0_avm_unnamed_vector_add2_address),
      .avm_unnamed_vector_add2_writedata(vector_add_0_avm_unnamed_vector_add2_writedata),
      .avm_unnamed_vector_add2_byteenable(vector_add_0_avm_unnamed_vector_add2_byteenable),
      .avm_unnamed_vector_add2_waitrequest(vector_add_0_avm_unnamed_vector_add2_waitrequest),
      .avm_unnamed_vector_add2_readdata(vector_add_0_avm_unnamed_vector_add2_readdata),
      .avm_unnamed_vector_add2_readdatavalid(vector_add_0_avm_unnamed_vector_add2_readdatavalid),
      .avm_unnamed_vector_add2_writeack(vector_add_0_avm_unnamed_vector_add2_writeack)
   );

   // INST vector_add_start_elem_inst_0 of acl_start_signal_chain_element
   acl_start_signal_chain_element
   #(
      .ASYNC_RESET(1),
      .SYNCHRONIZE_RESET(0)
   )
   vector_add_start_elem_inst_0
   (
      .clock(clock),
      .resetn(resetn),
      .start_in(vector_add_start_chain[0]),
      .start_kernel(vector_add_start_kernel_copy[0]),
      .start_finish_detector(vector_add_start_task_fd[0]),
      .start_finish_chain_element(vector_add_start_finish_element[0]),
      .start_chain()
   );
...
/////////////////////////////////////////////////////////////////
// MODULE vector_add_top_wrapper_0
/////////////////////////////////////////////////////////////////
module vector_add_top_wrapper_0
(
   input logic start,
   ...
   input logic clock2x,
   // AVM avm_unnamed_vector_add0
   output logic avm_unnamed_vector_add0_enable,
   output logic avm_unnamed_vector_add0_read,
   output logic avm_unnamed_vector_add0_write,
   output logic [4:0] avm_unnamed_vector_add0_burstcount,
   output logic [29:0] avm_unnamed_vector_add0_address,
   output logic [255:0] avm_unnamed_vector_add0_writedata,
   output logic [31:0] avm_unnamed_vector_add0_byteenable,
   input logic avm_unnamed_vector_add0_waitrequest,
   input logic [255:0] avm_unnamed_vector_add0_readdata,
   input logic avm_unnamed_vector_add0_readdatavalid,
   input logic avm_unnamed_vector_add0_writeack,
   // AVM avm_unnamed_vector_add1
   output logic avm_unnamed_vector_add1_enable,
   output logic avm_unnamed_vector_add1_read,
   output logic avm_unnamed_vector_add1_write,
   output logic [4:0] avm_unnamed_vector_add1_burstcount,
   output logic [29:0] avm_unnamed_vector_add1_address,
   output logic [255:0] avm_unnamed_vector_add1_writedata,
   output logic [31:0] avm_unnamed_vector_add1_byteenable,
   input logic avm_unnamed_vector_add1_waitrequest,
   input logic [255:0] avm_unnamed_vector_add1_readdata,
   input logic avm_unnamed_vector_add1_readdatavalid,
   input logic avm_unnamed_vector_add1_writeack,
   // AVM avm_unnamed_vector_add2
   output logic avm_unnamed_vector_add2_enable,
   output logic avm_unnamed_vector_add2_read,
   output logic avm_unnamed_vector_add2_write,
   output logic [4:0] avm_unnamed_vector_add2_burstcount,
   output logic [29:0] avm_unnamed_vector_add2_address,
   output logic [255:0] avm_unnamed_vector_add2_writedata,
   output logic [31:0] avm_unnamed_vector_add2_byteenable,
   input logic avm_unnamed_vector_add2_waitrequest,
   input logic [255:0] avm_unnamed_vector_add2_readdata,
   input logic avm_unnamed_vector_add2_readdatavalid,
   input logic avm_unnamed_vector_add2_writeack
);
   ...
   (
      ...
      .clock2x(clock2x),
      // AVM avm_unnamed_vector_add0
      .avm_unnamed_vector_add0_enable(avm_unnamed_vector_add0_enable),
      .avm_unnamed_vector_add0_read(avm_unnamed_vector_add0_read),
      .avm_unnamed_vector_add0_write(avm_unnamed_vector_add0_write),
      .avm_unnamed_vector_add0_burstcount(avm_unnamed_vector_add0_burstcount),
      .avm_unnamed_vector_add0_address(avm_unnamed_vector_add0_address),
      .avm_unnamed_vector_add0_writedata(avm_unnamed_vector_add0_writedata),
      .avm_unnamed_vector_add0_byteenable(avm_unnamed_vector_add0_byteenable),
      .avm_unnamed_vector_add0_waitrequest(avm_unnamed_vector_add0_waitrequest),
      .avm_unnamed_vector_add0_readdata(avm_unnamed_vector_add0_readdata),
      .avm_unnamed_vector_add0_readdatavalid(avm_unnamed_vector_add0_readdatavalid),
      .avm_unnamed_vector_add0_writeack(avm_unnamed_vector_add0_writeack),
      // AVM avm_unnamed_vector_add1
      .avm_unnamed_vector_add1_enable(avm_unnamed_vector_add1_enable),
      .avm_unnamed_vector_add1_read(avm_unnamed_vector_add1_read),
      .avm_unnamed_vector_add1_write(avm_unnamed_vector_add1_write),
      .avm_unnamed_vector_add1_burstcount(avm_unnamed_vector_add1_burstcount),
      .avm_unnamed_vector_add1_address(avm_unnamed_vector_add1_address),
      .avm_unnamed_vector_add1_writedata(avm_unnamed_vector_add1_writedata),
      .avm_unnamed_vector_add1_byteenable(avm_unnamed_vector_add1_byteenable),
      .avm_unnamed_vector_add1_waitrequest(avm_unnamed_vector_add1_waitrequest),
      .avm_unnamed_vector_add1_readdata(avm_unnamed_vector_add1_readdata),
      .avm_unnamed_vector_add1_readdatavalid(avm_unnamed_vector_add1_readdatavalid),
      .avm_unnamed_vector_add1_writeack(avm_unnamed_vector_add1_writeack),
      // AVM avm_unnamed_vector_add2
      .avm_unnamed_vector_add2_enable(avm_unnamed_vector_add2_enable),
      .avm_unnamed_vector_add2_read(avm_unnamed_vector_add2_read),
      .avm_unnamed_vector_add2_write(avm_unnamed_vector_add2_write),
      .avm_unnamed_vector_add2_burstcount(avm_unnamed_vector_add2_burstcount),
      .avm_unnamed_vector_add2_address(avm_unnamed_vector_add2_address),
      .avm_unnamed_vector_add2_writedata(avm_unnamed_vector_add2_writedata),
      .avm_unnamed_vector_add2_byteenable(avm_unnamed_vector_add2_byteenable),
      .avm_unnamed_vector_add2_waitrequest(avm_unnamed_vector_add2_waitrequest),
      .avm_unnamed_vector_add2_readdata(avm_unnamed_vector_add2_readdata),
      .avm_unnamed_vector_add2_readdatavalid(avm_unnamed_vector_add2_readdatavalid),
      .avm_unnamed_vector_add2_writeack(avm_unnamed_vector_add2_writeack)
   );
...
(
   ...
   input logic clock2x,
   // AVM gmem0_mtree_avm
   input logic gmem0_mtree_avm_enable [3],
   input logic gmem0_mtree_avm_read [3],
   input logic gmem0_mtree_avm_write [3],
   input logic [4:0] gmem0_mtree_avm_burstcount [3],
   input logic [29:0] gmem0_mtree_avm_address [3],
   input logic [255:0] gmem0_mtree_avm_writedata [3],
   input logic [31:0] gmem0_mtree_avm_byteenable [3],
   output logic gmem0_mtree_avm_waitrequest [3],
   output logic [255:0] gmem0_mtree_avm_readdata [3],
   output logic gmem0_mtree_avm_readdatavalid [3],
   output logic gmem0_mtree_avm_writeack [3],
   // AVM mtree_mem_gmem0_port_0_0_rw
